    ...
    static func places(fromData data: Data) -> [Place]? {
       ...
       static func place(fromJSON json: [String: Any]) -> Place? {
        ...
        guard let id = json["place_id"] as? String, let name = json["name"] as? String, let vicinity = json["vicinity"] as? String,
              let photos = json["photos"] as? [String: Any], let photo = photos["0"] as? [String: Any], let photoReference = photo["photo_reference"] as? String,
              let rating = json["rating"] as? String, let openingHours = json["opening_hours"] as? [String: Any], let openNow = openingHours["open_now"] as? Bool
           else {
               return nil
           }
