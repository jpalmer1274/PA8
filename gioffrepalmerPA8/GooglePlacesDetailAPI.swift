...
struct GooglePlacesDetailAPI {
    ...
    static func place(fromData data: Data) -> Place? {
           ...
           do {
               ...
               guard let jsonDictionary = jsonObject as? [String: Any], let placeDetails = jsonDictionary["result"] as? [String: Any], let id = placeDetails["place_id"] as? String, let name = placeDetails["name"] as? String, let vicinity = placeDetails["vicinity"] as? String, let rating = placeDetails["rating"] as? String,
                     let photos = placeDetails["photos"] as? [String: Any], let photo = photos["0"] as? [String: Any], let photoReference = photo["photo_reference"] as? String,
